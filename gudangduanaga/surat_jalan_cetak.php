...
function getCompanyHeader($warehouseName)
{
    ...
    $map = [
        'PT. Dua Naga Kosmetindo' => [
            ...
            'web'           => '',
            'city_line'     => 'Sukoharjo',
            'form_number'   => 'DNK-FORM-PD-04-02',
            'effective_date'=> 'Agustus 2025',
            'replace_no'    => 'A00',
            'form_date'     => '05 April 2020',
        ],
        'CV. Zweena Adi Nugraha' => [
            ...
            'city_line'     => 'Sukoharjo',
            'form_number'   => 'WH/FORM/013/01',
            'effective_date'=> '25 November 2021',
            'replace_no'    => 'ZAN-FORM-WH-02-08',
            'form_date'     => '20 Januari 2020',
        ],
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .footer-ttd .sign-header {
            text-align: center;
            font-weight: bold;
        }
        .footer-ttd .sign-role {
            text-align: center;
        }
        .footer-ttd .date-cell {
            text-align: right;
            white-space: nowrap;
        }
        .footer-ttd .print-info {
            font-size: 8.5px;
        }
        ...
        <tr>
            ...
            <td class="header-info-cell">
                <table class="mini-info">
                    ...
                    <tr>
                        <td>Nomor</td>
                        <td>: <?= htmlspecialchars($company['form_number']); ?></td>
                    </tr>
                    <tr>
                        <td>Tanggal berlaku</td>
                        <td>: <?= htmlspecialchars($company['effective_date']); ?></td>
                    </tr>
                    <tr>
                        <td>Mengganti No.</td>
                        <td>: <?= htmlspecialchars($company['replace_no']); ?></td>
                    </tr>
                    <tr>
                        <td>Tanggal</td>
                        <td>: <?= htmlspecialchars($company['form_date']); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                <table width="100%" class="footer-ttd">
                    ...
                    <tr>
                        <td class="sign-header">Disiapkan Oleh,</td>
                        <td class="sign-header">Dicek Kembali Oleh,</td>
                        <td class="sign-header">Disetujui Oleh,</td>
                        <td class="sign-header">Penerima,</td>
                        <td class="sign-header">Disetujui Oleh,</td>
                    </tr>

                    <!-- Baris space tanda tangan -->
                    <tr>
                        <td class="space"></td>
                        <td class="space"></td>
                        <td class="space"></td>
                    ...
                    <!-- Baris jabatan -->
                    <tr>
                        <td class="sign-role">Gudang</td>
                        <td class="sign-role">Security</td>
                        <td class="sign-role">Finance</td>
                        <td class="sign-role">Customer/Ekspedisi</td>
                        <td class="sign-role">Office</td>
                    </tr>

                    <!-- Info cetak -->
                    <tr>
                        <td colspan="5" class="print-info" style="padding-top:5px;">
